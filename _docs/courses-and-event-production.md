...
Although we are at heart a consulting company, we do offer quite a lot of courses and seminars. In fact, every week we run 1-2 public courses at our office in Madrid. So how does that work with our model?

How we do courses
-----------------

etéreo itself doesn't really run courses, it just provides the platform.

Anyone at etéreo can organize a course (or any kind of event), and when they do so they implicitly take on the Producer role for that course.
...
-   As Producer, you use the etéreo Calendar (a shared Google calendar) to book the classroom and make sure there isn't a conflict.
-   As Producer, you own the financial result of your course (win or loss). Just like with consulting, etéreo retains X% of your profit (see [economic model](economic-model.html)).
-   etéreo's role is to be the "platform", providing things such as a classroom (we have a classroom at our office in Madrid), onsite assistance (serving coffee & snacks, etc) and lots of administrative support (invoices, lunch reservation, email communication, registration page, etc). The [office team](office-team.html) organizes all of that.
-   etéreo will charge the producer a fixed course admin fee (usually around €600-700 per day), an all-inclusive fee that covers the cost of the office and all administrative support.

The Producer doesn't necessarily have to teach the course (although that's the most common case). Sometimes a producer will invite a "star" (someone outside of etéreo who is a well-known "guru" within his/her field) and host or co-teach a course.
...
2.  Joe opens the etéreo calendar on Google, finds an open slot Feb 12-13, and writes "LOKAL: Agile Engineering course (Joe)". (LOKAL means "venue" in Spanish, our convention for booking different parts of the office)
...
7.  Feb 12 arrives. Joe shows up at etéreo. Breakfast is served, handouts printed, everything ready to go thanks to the awesome office team!
...
11. Joe figures out the course profit and sends an invoice to etéreo (minus the [etéreo tax](economic-model.html), just like with any consulting).
...
Typically one of the producers of an upcoming course will take lead on this, talk to other producers, agree on what should be in the email (usually via a shared Google Doc), and send the email. They will of course also market the courses through their personal networks, LinkedIn, Facebook, Twitter, and whatever other channels make sense. If a course needs an extra push they might ask other etéreotypes to retweet, etc.
...
Fortunately, etéreo doesn't charge the Producer for a course if it got canceled. It's like a small insurance (or failure cushion). As a result, the cost of canceling a course is quite low for the producer (except for damaged pride). Why? Because we *want* people to experiment with new types of courses, since that benefits everyone in the long run. Make innovation easier by minimizing the cost of failure!

### Fake it till you make it

A few etéreotypes puts up registrations for courses for which no course material exists. If no one signs up, then no one is harmed. If enough people sign-up, then there can be a mad scramble to create the course the few weeks before the course. This may not sound like a serious way to run things, but in a way it is like a lean startup - make a minimal product and see if it flies. And regardless of how professional a course may seem, the first time it was held the teachers were out on a limb and very nervous about it.

This model works as long as nobody gets too reckless! Too many canceled courses would hurt the etéreo brand (see [how we build the brand](brand-building)). So far that hasn't been a problem though.
